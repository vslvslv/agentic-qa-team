...
description: |
  ...
  any visual regressions. Works standalone or as a sub-agent of /qa-team. Use when
...
After each run, update the memory file at `.claude/agent-memory/qa-visual/MEMORY.md` (create if absent). Record:
