...
<!-- See also: qa-web/references/playwright-patterns.md — verified against v1.60; iteration 28 (2026-05-12) adds: updateSourceMethod patch/overwrite/3-way modes for inline snapshot updates, dialog handler contract (must accept/dismiss or page hangs), page.evaluateHandle() multi-handle destructuring pattern, deviceScaleFactor HiDPI/Retina emulation, testResult.annotations per-retry reporter access; community gotchas #34 (dialog listener without accept/dismiss hangs test), #35 (evaluate closure scope — variables are undefined in browser context); 35 community gotchas total; 7600+ lines -->
